...
//
// One array per footer column, so the grouping is a decision here rather than a
// side effect of where the list happens to wrap: places on the island first,
// then the practical ones that point off it.
//
